...
diff -r --exclude=__pycache__ "$root/green/src/resources/io/github/getcolors/postgres-agy" "$root/red/resources"
diff -r --exclude=__pycache__ "$root/green/src/resources/io/github/getcolors/postgres-agy" "$root/blue/src/package_postgres_agy_blue/resources"
